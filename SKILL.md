...
这个 skill 默认参考三本书作为底层逻辑。复盘时可以吸收这些原则，但不要生硬引用书名，也不要把输出写成读书笔记。

1. **Kate Murphy《You're Not Listening》**
   - 使用原则：为理解而听，不是为回答而听。
   - 使用原则：沉默和停顿是工具，不需要立刻填满每个空白。

2. **Charles Duhigg《Supercommunicators》**
   - 使用原则：对话有不同频道，包括实用频道、情感频道、社交频道。
   - 使用原则：“再聊一会儿”的机会经常出现在频道切换处。

3. **Dean Nelson《Talk to Me》**
   - 使用原则：好的追问不是问更多问题，而是问到对方还没完全想清楚、但已经快要说出来的地方。

这三本书是默认理论底座，不是固定限制。
如果用户有自己的沟通方法、访谈框架、咨询训练或喜欢的书，可以增加、替换或改写这部分参考来源，并据此调整复盘逻辑。
